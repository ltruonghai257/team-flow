...
knowledge_session_type = sa.Enum(
    "presentation",
    "demo",
    "workshop",
    "qa",
    name="knowledgesessiontype",
    create_type=False,
)
...
def upgrade() -> None:
    ...
    if bind.dialect.name == "postgresql":
        ...
        knowledge_session_type.create(bind, checkfirst=True)
    ...
    op.create_table(
        ...
        sa.Column("session_type", knowledge_session_type, nullable=False),
