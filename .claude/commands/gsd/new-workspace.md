...
<execution_context>
@C:/Project/team-flow/.claude/get-shit-done/workflows/new-workspace.md
@C:/Project/team-flow/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @C:/Project/team-flow/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
