...
<execution_context>
@C:/Project/team-flow/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @C:/Project/team-flow/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
