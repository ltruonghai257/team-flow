...
<execution_context>
@C:/Project/team-flow/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @C:/Project/team-flow/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
