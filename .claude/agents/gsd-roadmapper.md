...
Reference full template: `C:/Project/team-flow/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Project/team-flow/.claude/get-shit-done/templates/state.md`.
