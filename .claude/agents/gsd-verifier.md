...
<required_reading>
@C:/Project/team-flow/.claude/get-shit-done/references/verification-overrides.md
...
@C:/Project/team-flow/.claude/get-shit-done/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@C:/Project/team-flow/.claude/get-shit-done/references/few-shot-examples/verifier.md
