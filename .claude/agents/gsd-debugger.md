...
<required_reading>
@C:/Project/team-flow/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/Project/team-flow/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Project/team-flow/.claude
                  → checks C:/Project/team-flow/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Project/team-flow/.claude/get-shit-done
                  → writes to C:/Project/team-flow/.claude/get-shit-done/hooks/
...
@C:/Project/team-flow/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/Project/team-flow/.claude/get-shit-done/references/common-bug-patterns.md
