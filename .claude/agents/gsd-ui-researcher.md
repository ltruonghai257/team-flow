...
Use template from `C:/Project/team-flow/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Project/team-flow/.claude/get-shit-done/templates/UI-SPEC.md`
