...
```bash
INIT=$(node "C:/Project/team-flow/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Project/team-flow/.claude/get-shit-done/templates/spec.md.
