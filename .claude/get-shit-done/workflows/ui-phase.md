...
```markdown
Read C:/Project/team-flow/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Project/team-flow/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Project/team-flow/.claude/agents/gsd-ui-checker.md for instructions.
