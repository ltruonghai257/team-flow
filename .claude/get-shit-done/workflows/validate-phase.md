...
```
Task(
  prompt="Read C:/Project/team-flow/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Project/team-flow/.claude/get-shit-done/templates/VALIDATION.md`
