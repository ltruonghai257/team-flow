...
```bash
node "C:/Project/team-flow/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `C:/Project/team-flow/.claude/get-shit-done/templates/retrospective.md`.
