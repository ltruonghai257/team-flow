...
<template>
@C:/Project/team-flow/.claude/get-shit-done/templates/UAT.md
</template>
...
Read and follow `C:/Project/team-flow/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "C:/Project/team-flow/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @C:/Project/team-flow/.claude/get-shit-done/workflows/diagnose-issues.md
