...
- Name: status_transition.spec.ts >> Phase 18: Status Transition Graph >> Generate linear flow button creates draft transitions
- Location: tests/status_transition.spec.ts:85:2
