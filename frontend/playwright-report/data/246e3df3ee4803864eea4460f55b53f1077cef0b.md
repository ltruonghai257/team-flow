...
- Name: status_transition.spec.ts >> Phase 18: Status Transition Graph >> Status tab can be switched and persists in URL
- Location: tests/status_transition.spec.ts:180:2
