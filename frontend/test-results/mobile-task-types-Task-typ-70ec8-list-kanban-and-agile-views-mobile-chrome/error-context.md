...
- Name: mobile/task-types.spec.ts >> Task types >> shows type badges in list, kanban, and agile views
- Location: tests/mobile/task-types.spec.ts:142:2
...
Locator: getByText('Feature task', { exact: true })
Expected: visible
Error: strict mode violation: getByText('Feature task', { exact: true }) resolved to 2 elements:
    1) <p class="text-sm font-medium text-gray-100 leading-snug flex-1">Feature task</p> aka getByText('Feature task').first()
    2) <p class="text-sm font-medium text-gray-100 leading-snug flex-1">Feature task</p> aka getByText('Feature task').nth(1)

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Feature task', { exact: true })
        ...
        - generic [ref=e55]:
          ...
          - generic [ref=e90]:
            ...
            - generic [ref=e178]:
              ...
              - list [ref=e184]:
                - listitem [ref=e185]:
                  - generic [ref=e186]:
                    - generic [ref=e187]:
                      - paragraph [ref=e188]: Chore task
                      - button "Edit task" [ref=e189] [cursor=pointer]:
                        - img [ref=e190]
                    - paragraph [ref=e191]: Do the thing
                    - generic [ref=e192]:
                      - generic [ref=e193]:
                        - img [ref=e194]
                        - text: Task
            ...
            - generic [ref=e196]:
              - generic [ref=e197]:
                - generic [ref=e198]:
                  - heading "Done" [level=3] [ref=e200]
                  - generic [ref=e201]: Done
                - generic [ref=e202]: "0"
              - list [ref=e203]:
                - listitem [ref=e204]: No tasks in this status
            - generic [ref=e205]:
              - generic [ref=e206]:
                - heading "Blocked" [level=3] [ref=e209]
                - generic [ref=e210]: "0"
              - list [ref=e211]:
                - listitem [ref=e212]: No tasks in this status
```
...
```ts
  ...
  54  | 		id: 3,
  55  | 		title: 'Chore task',
  56  | 		description: 'Do the thing',
  57  | 		status: 'review',
  58  | 		priority: 'low',
  59  | 		type: 'task',
  60  | 		due_date: null,
  61  | 		completed_at: null,
  62  | 		estimated_hours: null,
  63  | 		tags: null,
  64  | 		project_id: 1,
  65  | 		milestone_id: null,
  66  | 		assignee_id: null,
  67  | 		creator_id: 1,
  68  | 		created_at: '2026-04-24T00:00:00Z',
  69  | 		updated_at: '2026-04-24T00:00:00Z',
  70  | 		assignee: null
  71  | 	}
  72  | ];
  73  | 
