...
- Name: mobile/kanban-scroll.spec.ts >> Kanban horizontal scroll on mobile (375px) >> kanban board scrolls horizontally
- Location: tests/mobile/kanban-scroll.spec.ts:11:2
...
Locator: locator('.overflow-x-auto').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.overflow-x-auto').first()
